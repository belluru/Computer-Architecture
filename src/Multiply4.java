...
public class Multiply4 extends MainClass
{
	...
	Multiply4(int from_constructor)
	{
		cc=0;
		is_in_scope=false;
	...
	Multiply4(boolean from_constructor,int line_Number)
	{
		is_in_scope=true;
		...
		Instruction_Sequence.set(line_Number, Instruction_Sequence.get(line_Number)+"M4        ");
	}
