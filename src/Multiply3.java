...
public class Multiply3 extends MainClass
{
	...
	Multiply3(int from_constructor)
	{
		cc=0;
		is_in_scope=false;
	...
	Multiply3(boolean from_constructor,int line_Number)
	{
		is_in_scope=true;
		...
		Instruction_Sequence.set(line_Number, Instruction_Sequence.get(line_Number)+"M3        ");
	}
